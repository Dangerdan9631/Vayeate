...
1. Place in the feature-owned app folder used by the surrounding domain, such as `vayeate-theme-studio/src/app/<domain>/<feature-or-component>/`; use `components/<component>/` only where that pattern already exists locally.
