...
- UI and Electron:
  - main editor shell: `vayeate-theme-studio/src/app/app/components/App.tsx`
  - components: `vayeate-theme-studio/src/app/{app,catalog,common,template,theme}/components/`
