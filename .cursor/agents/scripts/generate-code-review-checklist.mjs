/**
 * Writes code-review/checklist.md with one section per Cursor rule and one
 * checkbox per implementation file relevant to that rule.
 */
import fs from "fs";
...
const ruleFiles = listFiles(rulesRoot, (file) => path.basename(file).endsWith(".mdc"));
