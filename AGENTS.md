...
|---|---|---|
| Theme generation or contrast logic changes | `.github/skills/theme-generation.md` | `vayeate-theme-studio/src/domain/core/theme-generator.ts`, `vayeate-theme-studio/src/domain/core/color.ts`, `.github/agent-docs/edge-cases.md` |
...
| Safety/path/output behavior changes | `.github/agent-docs/edge-cases.md` | `vayeate-theme-studio/src/domain/core/theme-exporter.ts`, `.github/skills/safe-change-validation.md` |
...
| Undo / UndoManagerV2 (implement or refactor the manager) | `.cursor/skills/undo-manager-v2/SKILL.md` | `vayeate-theme-studio/src/domain/utils/undo-stack.ts`, `vayeate-theme-studio/src/app/ui/context/UndoContext.tsx` when implementing or migrating |
| Adding a new undo action type | `.cursor/skills/define-undo-action/SKILL.md` | `vayeate-theme-studio/src/domain/utils/undo-manager-v2.ts`, `.cursor/rules/vayeate-theme-studio-undo.mdc` |
...
- Standalone Theme Studio app:
  ...
  - `vayeate-theme-studio/src/app/ui/*`
