---
name: modify-electron-layer
description: Electron layer rules, main process boundaries, and IPC integration patterns. Use when authoring, modifying, or interacting with Electron files
---
