---
name: modify-validation
description: Validation contract, test method patterns, composition rules, and controller integration. Use when authoring, modifying, or interacting with validations
---
