...
description: React component contract, patterns, and anti-patterns for PascalCase functional components. Use when authoring, modifying, or interacting with react components
---
