...
export class AddSemanticVariantController {
  constructor(
    ...
    private readonly generateSemanticVariantKey: GenerateSemanticVariantKey,
    private readonly mergeSemanticTokenSets: MergeSemanticTokenSets,
    private readonly appendSemanticVariantToTemplate: AppendSemanticVariantToTemplate,
