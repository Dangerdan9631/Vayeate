import type { UndoProcessor, UndoStack } from '../../../core/Common/undo-stack-types';
import { undoManagerV2 } from '../../../core/Common/undo-manager-v2';
import {
  UNDO_BASELINE_FRAME_ID,
  type HistoryTransitionResult,
  type UndoHistoryListEntry,
} from '../../../../model/Common/undo-history';
import { emptyUndoMenuSnapshot, type UndoMenuSnapshot } from '../../../state/Common/undo-stack/undo-stack-state';
import type { UndoStackStore } from '../../../state/Common/undo-stack/undo-stack-store';
