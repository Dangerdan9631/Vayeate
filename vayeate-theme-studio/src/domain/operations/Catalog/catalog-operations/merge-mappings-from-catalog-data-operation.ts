...
import type { CatalogReference, Mapping } from '../../../../model/Template/schema/template-schemas';
import type { MergeMappingsResult } from '../../../../model/Theme/schema/theme-schemas';

/**
 * Pre-loaded catalog snapshot passed to {@link MergeMappingsFromCatalogDataOperation}.
 */
 ...
 */
@singleton()
export class MergeMappingsFromCatalogDataOperation {

  /**
   * Merges existing mappings with the loaded catalog metadata.
  ...
  execute(
    ...
    for (const m of newMappings) {
      ...
      try {
        ...
        // Ignore invalid semantic selectors while preserving the mapping itself.
      }
    }
