import type { UndoProcessor, UndoStack } from '../../../core/Undo/undo-stack-types';
...
} from '../../../../model/Undo/undo-history';
import { emptyUndoMenuSnapshot, type UndoMenuSnapshot } from '../../../state/Undo/undo-stack/undo-stack-state';
import type { UndoStackStore } from '../../../state/Undo/undo-stack/undo-stack-store';
