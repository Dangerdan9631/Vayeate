...
import type { ApplyTemplateLifecycleUndoOperation } from '../../Template/template-undo-operations/apply-template-lifecycle-undo-operation';
import type { ApplyTemplateUndoStateOperation } from '../../Template/template-undo-operations/apply-template-undo-state-operation';
