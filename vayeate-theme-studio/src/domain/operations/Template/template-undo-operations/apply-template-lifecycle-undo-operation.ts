...
import type { TemplateLifecycleUndoSnapshot } from '../../../../model/Template/template-undo-lifecycle';
import type { TemplateReference } from '../../../../model/Theme/schema/theme-schemas';
import { DeleteTemplateOperation } from '../../Template/template-operations/template-list/delete-template-operation';
import { LoadTemplateOperation } from '../../Template/template-operations/template-details/load-template-operation';
import { RefreshTemplateRefsOperation } from '../../Template/template-operations/template-list/refresh-template-refs-operation';
import { SetSelectedTemplateRefOperation } from '../../Template/template-operations/template-list/set-selected-template-ref-operation';
import { SetTemplateOperation } from '../../Template/template-operations/template-details/set-template-operation';
