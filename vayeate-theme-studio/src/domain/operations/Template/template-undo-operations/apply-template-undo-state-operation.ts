...
import { entityRefsChanged } from '../../../utils/Common/entity-refs-changed';
import { SaveTemplateOperation } from '../../Template/template-operations/template-details/save-template-operation';
import { RefreshTemplateRefsAndSelectOperation } from '../../Template/template-operations/template-list/refresh-template-refs-and-select-operation';
