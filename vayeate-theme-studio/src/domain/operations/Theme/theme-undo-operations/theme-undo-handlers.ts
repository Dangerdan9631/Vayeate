...
import type { ThemeLifecycleUndoSnapshot } from '../../../../model/Theme/theme-undo-lifecycle';
...
import type { UndoAction } from '../../../core/Undo/undo-stack-types';
import type { UndoDiffHandler } from '../../../core/Undo/undo-processor';
...
import type { SetThemeHueReferenceHexOperation } from '../../Theme/theme-operations/palette-hue/set-theme-hue-reference-hex-operation';
import type { SetThemePaneSelectionsOperation } from '../../Theme/theme-operations/pickers/set-theme-pane-selections-operation';
import type { SetColorUseDarkForLightOperation } from '../../Theme/theme-operations/theme-details/set-color-use-dark-for-light-operation';
import type { SetColorVariableDarkOperation } from '../../Theme/theme-operations/theme-details/set-color-variable-dark-operation';
import type { SetColorVariableLightOperation } from '../../Theme/theme-operations/theme-details/set-color-variable-light-operation';
import type { SetContrastUseDarkForLightOperation } from '../../Theme/theme-operations/theme-details/set-contrast-use-dark-for-light-operation';
import type { SetContrastVariableFieldOperation } from '../../Theme/theme-operations/theme-details/set-contrast-variable-field-operation';
import type { SetThemeApplyPaletteToDarkOperation } from '../../Theme/theme-operations/theme-details/set-theme-apply-palette-to-dark-operation';
import type { SetThemeApplyPaletteToLightOperation } from '../../Theme/theme-operations/theme-details/set-theme-apply-palette-to-light-operation';
import type { SetThemeLoadedTemplateOperation } from '../../Theme/theme-operations/theme-details/set-theme-loaded-template-operation';
import type { SetThemePaletteClusterCountOperation } from '../../Theme/theme-operations/theme-details/set-theme-palette-cluster-count-operation';
import type { SetThemePreviewTokenRefFieldOperation } from '../../Theme/theme-operations/theme-details/set-theme-preview-token-ref-field-operation';
import type { ApplyThemeLifecycleUndoOperation } from '../../Theme/theme-undo-operations/apply-theme-lifecycle-undo-operation';
import type { ApplyThemeUndoStateOperation } from '../../Theme/theme-undo-operations/apply-theme-undo-state-operation';
import type { RestoreThemePaletteAssignUndoOperation } from '../../Theme/theme-undo-operations/restore-theme-palette-assign-undo-operation';
