...
import type { TokenizedPreviewLine } from '../../../../../model/Theme/preview-types';
import { contrastRatio } from './color-wcag-operation';
import type { ScopeColorMap, ScopeColorMapEntry } from './scope-resolver-operation';
import { resolveTokenColor, resolveTokenEntry } from './scope-resolver-operation';
...
/**
 * Operation wrapper for theme resolve editor preview lines helpers.
 */
@singleton()
export class ResolveEditorPreviewLinesOperation {}
