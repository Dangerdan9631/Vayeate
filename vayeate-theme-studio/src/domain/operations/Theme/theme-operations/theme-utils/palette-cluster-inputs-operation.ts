...
import type { ColorVariable } from '../../../../../model/Template/schema/template-schemas';
...
/**
 * Operation wrapper for theme palette cluster inputs helpers.
 */
@singleton()
export class PaletteClusterInputsOperation {}
