...
import { normalizeThemeHex } from './normalize-theme-hex-operation';
...
/**
 * Operation wrapper for theme compute selected colors display helpers.
 */
@singleton()
export class ComputeSelectedColorsDisplayOperation {}
