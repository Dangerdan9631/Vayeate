...
import type { Hsl, Hsv, Rgb } from './color-types-operation';
import { hexToRgb, rgbToHex } from './color-hex-operation';
...
/**
 * Operation wrapper for theme color hsl helpers.
 */
@singleton()
export class ColorHslOperation {}
