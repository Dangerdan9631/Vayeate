...
import type { ContrastAssignment, ContrastAssignmentValue } from '../../../../../model/Theme/schema/theme-schemas';
...
/**
 * Operation wrapper for theme contrast utils helpers.
 */
@singleton()
export class ContrastUtilsOperation {}
