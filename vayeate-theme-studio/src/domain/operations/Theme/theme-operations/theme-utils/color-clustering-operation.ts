...
import type { Rgb } from './color-types-operation';
import { hexToRgb } from './color-hex-operation';
...
/**
 * Operation wrapper for theme color clustering helpers.
 */
@singleton()
export class ColorClusteringOperation {}
