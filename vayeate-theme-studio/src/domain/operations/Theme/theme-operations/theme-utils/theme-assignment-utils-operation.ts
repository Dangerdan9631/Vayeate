...
import { applyHueShift, applySaturationValueAdjustment } from './color-hsl-operation';
...
/**
 * Operation wrapper for theme theme assignment utils helpers.
 */
@singleton()
export class ThemeAssignmentUtilsOperation {}
