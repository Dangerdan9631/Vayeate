...
export const themeSchema = z
  .object({
    ...
    themeBackgroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
    lineNumberBackgroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
    lineNumberBackgroundContrastVariableRef: contrastVariableKeySchema.nullable().optional(),
    lineNumberForegroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
    lineNumberForegroundContrastVariableRef: contrastVariableKeySchema.nullable().optional(),
    ideTabColorVariableRef: colorVariableKeySchema.nullable().optional(),
    ideTabContrastVariableRef: contrastVariableKeySchema.nullable().optional(),
    ideTabBarBackgroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
    ideTabBarBackgroundContrastVariableRef: contrastVariableKeySchema.nullable().optional(),
    ideTabBarForegroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
    ideTabBarForegroundContrastVariableRef: contrastVariableKeySchema.nullable().optional(),
    editorPreviewScrollbarBackgroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
    editorPreviewScrollbarBackgroundContrastVariableRef: contrastVariableKeySchema.nullable().optional(),
    editorPreviewScrollbarForegroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
    editorPreviewScrollbarForegroundContrastVariableRef: contrastVariableKeySchema.nullable().optional(),
    editorPreviewSelectionBackgroundColorVariableRef: colorVariableKeySchema.nullable().optional(),
