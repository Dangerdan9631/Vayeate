...
import type { TabId } from '../Common/app-ui';
import type { CatalogReference } from '../Template/schema/template-schemas';
import type { TemplateReference, ThemeReference } from '../Theme/schema/theme-schemas';
