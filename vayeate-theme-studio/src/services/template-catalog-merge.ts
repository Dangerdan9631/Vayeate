...
import type { CatalogReference, Mapping, Token } from '../model/schemas';
...
/**
 * Merge template mappings with catalog tokens for the given catalog refs.
 * Used by template controller and viewmodel for toggle catalog, change version, update all.
 */
export async function mergeMappingsFromCatalogRefs(
