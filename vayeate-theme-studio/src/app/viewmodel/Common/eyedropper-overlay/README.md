...
- Path: `src/app/viewmodel/Common/eyedropper-overlay`
- Layer: App layer
...
- Subfolders: None
- Files: `use-eyedropper-canvas-viewmodel.ts`, `use-eyedropper-loupe-viewmodel.ts`, `use-eyedropper-overlay-viewmodel.ts`
