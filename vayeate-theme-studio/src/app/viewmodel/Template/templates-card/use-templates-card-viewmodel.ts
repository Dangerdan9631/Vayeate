...
import { TemplatesCardActionType } from '../../../actions/Template/templates-card/templates-card-action-type';
import { container } from 'tsyringe';
import { getCurrentTemplateRefs, TemplatesStore } from '../../../../domain/state/Template/data/templates-store';
