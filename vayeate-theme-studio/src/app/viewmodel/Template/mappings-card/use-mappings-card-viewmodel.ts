...
import type { CatalogReference, ColorVariable, ContrastVariable, Mapping, StyleVariable } from '../../../../model/Template/schema/template-schemas';
import { MappingsCardActionType } from '../../../actions/Template/mappings-card/mappings-card-action-type';
import { computeOrphanKeys, type SemanticCatalogInfo } from '../../../../domain/utils/Common/compute-orphan-keys';
...
import type { TriState } from '../../../components/Common/tristate-checkbox/TriStateCheckbox';
