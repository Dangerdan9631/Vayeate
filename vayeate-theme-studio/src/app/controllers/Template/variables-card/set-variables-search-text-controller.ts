...
import { SetTemplateVariablesSearchTextOperation } from '../../../../domain/operations/Template/template-operations/variables/set-template-variables-search-text-operation';
