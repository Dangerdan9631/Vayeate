...
import { UpdateVariableGroupRefOperation as UpdateVariableGroupRefOp } from '../../../../domain/operations/Template/template-operations/variables/update-variable-group-ref-operation';
...
import { TEMPLATE_VARIABLE_GROUP_REF_UPDATED } from '../../../../model/Common/undo-action-types';
