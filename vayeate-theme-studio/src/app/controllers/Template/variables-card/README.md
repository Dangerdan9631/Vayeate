...
- Path: `src/app/controllers/Template/variables-card`
- Layer: App layer
...
- Subfolders: None
- Files: `add-color-variable-controller.ts`, `add-variable-controller.ts`, `remove-variable-controller.ts`, `set-template-add-variable-name-controller.ts`, `set-variables-search-text-controller.ts`, `update-contrast-comparison-source-controller.ts`, `update-variable-group-ref-controller.ts`
