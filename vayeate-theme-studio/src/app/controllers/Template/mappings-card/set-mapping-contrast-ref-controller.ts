...
import { SetMappingContrastRefOperation as SetMappingContrastRefOp } from '../../../../domain/operations/Template/template-operations/mappings/set-mapping-contrast-ref-operation';
...
import { TEMPLATE_MAPPING_CONTRAST_REF_SET } from '../../../../model/Common/undo-action-types';
