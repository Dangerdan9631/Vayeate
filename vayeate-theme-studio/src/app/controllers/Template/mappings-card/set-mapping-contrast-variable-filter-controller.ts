...
import { SetTemplateMappingContrastVariableFilterOperation } from '../../../../domain/operations/Template/template-operations/mappings/set-template-mapping-contrast-variable-filter-operation';
