...
import { SetMappingIgnoredOperation } from '../../../../domain/operations/Template/template-operations/mappings/set-mapping-ignored-operation';
...
import { TEMPLATE_MAPPING_IGNORED_SET } from '../../../../model/Common/undo-action-types';
