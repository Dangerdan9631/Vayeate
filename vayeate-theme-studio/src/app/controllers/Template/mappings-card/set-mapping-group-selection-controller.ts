...
import { SetTemplateMappingSelectionBatchOperation } from '../../../../domain/operations/Template/template-operations/mappings/set-template-mapping-selection-batch-operation';
