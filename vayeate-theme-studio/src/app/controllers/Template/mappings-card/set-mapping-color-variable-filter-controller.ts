...
import { SetTemplateMappingColorVariableFilterOperation } from '../../../../domain/operations/Template/template-operations/mappings/set-template-mapping-color-variable-filter-operation';
