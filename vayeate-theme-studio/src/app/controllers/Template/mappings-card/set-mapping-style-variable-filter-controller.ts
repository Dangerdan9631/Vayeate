import type { StyleVariableKey } from '../../../../model/Common/schema/primitives';
import { singleton } from 'tsyringe';
import { SetTemplateMappingStyleVariableFilterOperation } from '../../../../domain/operations/Template/template-operations/mappings/set-template-mapping-style-variable-filter-operation';
