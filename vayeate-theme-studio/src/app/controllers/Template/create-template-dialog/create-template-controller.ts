...
import { CreateTemplateOperation } from '../../../../domain/operations/Template/template-operations/template-list/create-template-operation';
import { RefreshTemplateRefsOperation } from '../../../../domain/operations/Template/template-operations/template-list/refresh-template-refs-operation';
...
import { SetTemplateOperation } from '../../../../domain/operations/Template/template-operations/template-details/set-template-operation';
import { SetTemplateCreateDialogOpenOperation } from '../../../../domain/operations/Template/template-operations/template-list/set-template-create-dialog-open-operation';
import { SetTemplateIsCreatingOperation } from '../../../../domain/operations/Template/template-operations/template-list/set-template-is-creating-operation';
