...
- Path: `src/app/controllers/Template/template-catalogs-card`
- Layer: App layer
...
- Subfolders: None
- Files: `change-catalog-version-controller.ts`, `toggle-catalog-controller.ts`, `update-all-catalogs-controller.ts`
