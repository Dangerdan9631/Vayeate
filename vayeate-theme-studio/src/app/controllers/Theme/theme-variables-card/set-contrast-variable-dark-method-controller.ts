...
import { THEME_CONTRAST_VARIABLE_DARK_METHOD_SET } from '../../../../model/Common/undo-action-types';



/**

 * Orchestrates set contrast variable dark method work for the theme UI.
 ...
 * @returns Promise resolved when orchestration completes.
  ...
  async run(ref: ContrastVariableKey | undefined, value: ContrastComparisonMethod): Promise<void> {
    ...
    const edit = this.setContrastVariableField.execute(ref, 'dark', 'comparisonMethod', value);
    ...
    await this.recordThemeUndo.execute({
      ...
      description: 'Set contrast dark method',

      actionType: THEME_CONTRAST_VARIABLE_DARK_METHOD_SET,
