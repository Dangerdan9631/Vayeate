...
import { THEME_CONTRAST_VARIABLE_DARK_MAX_SET } from '../../../../model/Common/undo-action-types';



/**

 * Orchestrates set contrast variable dark max work for the theme UI.
 ...
 * @returns Promise resolved when orchestration completes.
  ...
  async run(ref: ContrastVariableKey | undefined, value: string): Promise<void> {
    ...
    const edit = this.setContrastVariableField.execute(ref, 'dark', 'max', num);
