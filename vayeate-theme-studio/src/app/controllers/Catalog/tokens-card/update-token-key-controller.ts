...
import { UpdateTokenKeyInCatalogOperation } from '../../../../domain/operations/Catalog/catalog-operations/tokens/update-token-key-in-catalog-operation';
...
import { CATALOG_TOKEN_KEY_UPDATED } from '../../../../model/Common/undo-action-types';
