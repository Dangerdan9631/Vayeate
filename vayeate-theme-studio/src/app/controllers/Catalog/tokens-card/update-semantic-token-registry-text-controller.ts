...
import { UpdateSemanticTokenRegistryEntryOperation } from '../../../../domain/operations/Catalog/catalog-operations/tokens/update-semantic-token-registry-entry-operation';
