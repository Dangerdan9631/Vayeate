...
import { SetCatalogNewSemanticTokenSelectorTextOperation } from '../../../../domain/operations/Catalog/catalog-operations/tokens/set-catalog-new-semantic-token-selector-text-operation';
...
import { CATALOG_SEMANTIC_SELECTOR_ADDED } from '../../../../model/Common/undo-action-types';
