import { ColorVariableKey, ContrastVariableKey, StyleVariableKey, TokenType } from "../../../../model/Common/schema/primitives";
...
import type { TemplateMappingAssignment, TemplateMappingId } from '../../../../model/Template/template-mapping-assignment';
...
export enum MappingsCardActionType {
  ...
  MappingStyleVariableFilterListOnSelect = 'TEMPLATE_MAPPING_STYLE_VARIABLE_FILTER_LIST_ON_SELECT',
  ...
  MappingExistingTokenStyleVariableListOnCommit = 'TEMPLATE_MAPPING_EXISTING_TOKEN_STYLE_VARIABLE_LIST_ON_COMMIT',
  MappingExistingTokenIgnoredCheckboxOnToggle = 'TEMPLATE_MAPPING_EXISTING_TOKEN_IGNORED_CHECKBOX_ON_TOGGLE',
...
export type MappingsCardActions =
  ...
  | { type: MappingsCardActionType.MappingStyleVariableFilterListOnSelect; values: StyleVariableKey[] }
  ...
  | { type: MappingsCardActionType.MappingExistingTokenStyleVariableListOnCommit; value: StyleVariableKey | null; tokenKey: string; tokenType: TokenType }
  | { type: MappingsCardActionType.MappingExistingTokenIgnoredCheckboxOnToggle; value: boolean; tokenKey: string; tokenType: TokenType }
