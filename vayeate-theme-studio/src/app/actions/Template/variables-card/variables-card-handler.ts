...
import { AddVariableController } from "../../../controllers/Template/variables-card/add-variable-controller";
import { RemoveVariableController } from "../../../controllers/Template/variables-card/remove-variable-controller";
import { SetTemplateAddVariableNameController } from "../../../controllers/Template/variables-card/set-template-add-variable-name-controller";
import { SetVariablesSearchTextController } from "../../../controllers/Template/variables-card/set-variables-search-text-controller";
import { UpdateContrastComparisonSourceController } from "../../../controllers/Template/variables-card/update-contrast-comparison-source-controller";
import { UpdateVariableGroupRefController } from "../../../controllers/Template/variables-card/update-variable-group-ref-controller";
