...
import { ChangeCatalogVersionController } from "../../../controllers/Template/template-catalogs-card/change-catalog-version-controller";
import { ToggleCatalogController } from "../../../controllers/Template/template-catalogs-card/toggle-catalog-controller";
import { UpdateAllCatalogsController } from "../../../controllers/Template/template-catalogs-card/update-all-catalogs-controller";
