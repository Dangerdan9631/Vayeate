...
import { TemplatePageHandler } from './template-page/template-page-handler';
import { isTemplatePageAction } from './template-page/template-page-action-type';
import { TemplatesCardHandler } from './templates-card/templates-card-handler';
import { isTemplatesCardAction } from './templates-card/templates-card-action-type';
import { TemplateCreateDialogHandler } from './create-template-dialog/template-create-dialog-handler';
import { isTemplateCreateDialogAction } from './create-template-dialog/template-create-dialog-action-type';
import { TemplateDetailsCardHandler } from './template-details-card/template-details-card-handler';
import { isTemplateDetailsCardAction } from './template-details-card/template-details-card-action-type';
import { TemplateCatalogsCardHandler } from './template-catalogs-card/template-catalogs-card-handler';
import { isTemplateCatalogsCardAction } from './template-catalogs-card/template-catalogs-card-action-type';
import { MappingsCardHandler } from './mappings-card/mappings-card-handler';
import { isMappingsCardAction } from './mappings-card/mappings-card-action-type';
import { GroupsCardHandler } from './groups-card/groups-card-handler';
import { isGroupsCardAction } from './groups-card/groups-card-action-type';
import { VariablesCardHandler } from './variables-card/variables-card-handler';
import { isVariablesCardAction } from './variables-card/variables-card-action-type';
