import { TemplatePageActions } from "./template-page/template-page-action-type";
import { TemplatesCardActions } from "./templates-card/templates-card-action-type";
import { TemplateCreateDialogActions } from "./create-template-dialog/template-create-dialog-action-type";
import { TemplateDetailsCardActions } from "./template-details-card/template-details-card-action-type";
import { TemplateCatalogsCardActions } from "./template-catalogs-card/template-catalogs-card-action-type";
...
import { isMappingsCardAction, tryCoalesceMappingsCardAction } from './mappings-card/mappings-card-action-type';
import { isGroupsCardAction, tryCoalesceGroupsCardAction } from './groups-card/groups-card-action-type';
import { isVariablesCardAction, tryCoalesceVariablesCardAction } from './variables-card/variables-card-action-type';
import { isTemplateCreateDialogAction, tryCoalesceTemplateCreateDialogAction } from './create-template-dialog/template-create-dialog-action-type';
