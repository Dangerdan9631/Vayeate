...
import { isAppShellAction, type AppShellActions } from './app-shell/app-shell-action-type';
import {
  isAppEyedropperOverlayAction,
  tryCoalesceAppEyedropperOverlayAction,
  type AppEyedropperOverlayActions,
} from './eyedropper-overlay/eyedropper-overlay-action-type';
import {
  isAppStyledTooltipAction,
  tryCoalesceAppStyledTooltipAction,
  type AppStyledTooltipActions,
} from './styled-tooltip/styled-tooltip-action-type';
import { isAppMenuAction, type AppMenuActions } from './menu-bar/app-menu-action-type';
import { isAppRibbonAction, type AppRibbonActions } from './ribbon/app-ribbon-action-type';
