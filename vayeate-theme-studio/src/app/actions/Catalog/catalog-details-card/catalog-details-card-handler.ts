...
import { AddNewSourceController } from "../../../controllers/Catalog/catalog-details-card/add-new-source-controller";
import { DeleteCurrentCatalogVersionController } from "../../../controllers/Catalog/catalog-details-card/delete-current-catalog-version-controller";
import { LockCatalogController } from "../../../controllers/Catalog/catalog-details-card/lock-catalog-controller";
import { RemoveSourceController } from "../../../controllers/Catalog/catalog-details-card/remove-source-controller";
import { RevertCatalogToVersionController } from "../../../controllers/Catalog/catalog-details-card/revert-catalog-to-version-controller";
import { SetCatalogNewSourceTokenTypeController } from "../../../controllers/Catalog/catalog-details-card/set-catalog-new-source-token-type-controller";
import { SetCatalogNewSourceTypeController } from "../../../controllers/Catalog/catalog-details-card/set-catalog-new-source-type-controller";
import { SetCatalogNewSourceUrlController } from "../../../controllers/Catalog/catalog-details-card/set-catalog-new-source-url-controller";
import { SyncCatalogController } from "../../../controllers/Catalog/catalog-details-card/sync-catalog-controller";
import { UpdateSourceTokenTypeController } from "../../../controllers/Catalog/catalog-details-card/update-source-token-type-controller";
import { UpdateSourceTypeController } from "../../../controllers/Catalog/catalog-details-card/update-source-type-controller";
import { UpdateSourceUrlController } from "../../../controllers/Catalog/catalog-details-card/update-source-url-controller";
