import { SetCatalogCreateDialogNameController } from "../../../controllers/Catalog/create-dialog/set-catalog-create-dialog-name-controller";
import { SetCatalogCreateDialogTypeController } from "../../../controllers/Catalog/create-dialog/set-catalog-create-dialog-type-controller";
import { CatalogCreateDialogActions, CatalogCreateDialogActionType } from "./catalog-create-dialog-action-type";
import { CloseCatalogCreateDialogController } from "../../../controllers/Catalog/create-dialog/close-catalog-create-dialog-controller";
