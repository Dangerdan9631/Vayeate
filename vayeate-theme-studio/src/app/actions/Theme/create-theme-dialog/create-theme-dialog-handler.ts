...
import { CloseThemeCreateDialogController } from '../../../controllers/Theme/create-theme-dialog/close-theme-create-dialog-controller';
import { CreateThemeController } from '../../../controllers/Theme/create-theme-dialog/create-theme-controller';
import { SetThemeCreateFormNameController } from '../../../controllers/Theme/create-theme-dialog/set-theme-create-form-name-controller';
