...
- Path: `src/app/core/Common/background-queue/controllers`
- Layer: App layer
- Role bucket: `core`
...
- Subfolders: None
- Files: `signal-background-queue-processing-complete-controller.ts`, `update-background-queue-status-controller.ts`
