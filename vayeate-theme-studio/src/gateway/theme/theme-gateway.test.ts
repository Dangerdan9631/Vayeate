...
describe('ThemeGateway', () => {
  it('saveTheme writes under data/themes and strips ephemeral variable refs from JSON', async () => {
    ...
    const gw = new ThemeGateway(createFsMock({ saveFile }));
  ...
  it('loadTheme returns parsed theme when file is valid JSON', async () => {
    ...
    const gw = new ThemeGateway(createFsMock({ loadFile }));
  ...
  it('listThemes maps filenames via parseFileName and returns refs', async () => {
    ...
    const gw = new ThemeGateway(createFsMock({ listFiles }));
  ...
  it('deleteTheme swallows deleteFile errors', async () => {
    ...
    const gw = new ThemeGateway(createFsMock({ deleteFile }));
