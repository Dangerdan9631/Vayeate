...
- [X] T017 [US1] Classify common component inventory for `src/app/components/Common/eyedropper-overlay/EyedropperOverlay.tsx`, `src/app/viewmodel/Common/eyedropper-overlay/use-eyedropper-overlay-viewmodel.ts`, `src/app/actions/Common/eyedropper-overlay/eyedropper-overlay-action-type.ts`, `src/app/actions/Common/eyedropper-overlay/eyedropper-overlay-handler.ts`, `src/app/components/Common/styled-tooltip/StyledTooltip.tsx`, `src/app/viewmodel/Common/styled-tooltip/use-styled-tooltip-viewmodel.ts`, `src/app/actions/Common/styled-tooltip/styled-tooltip-action-type.ts`, and `src/app/actions/Common/styled-tooltip/styled-tooltip-handler.ts`.
- [X] T018 [US1] Classify shell component inventory for `src/app/components/Common/app-shell/AppShell.tsx`, `src/app/viewmodel/Common/app-shell/use-app-shell-viewmodel.ts`, `src/app/actions/Common/app-shell/app-shell-action-type.ts`, `src/app/actions/Common/app-shell/app-shell-handler.ts`, `src/app/components/Common/menu-bar/MenuBar.tsx`, `src/app/viewmodel/Common/menu-bar/use-menubar-viewmodel.ts`, `src/app/components/Common/ribbon/Ribbon.tsx`, `src/app/viewmodel/Common/ribbon/use-ribbon-viewmodel.ts`, `src/app/components/Common/status-bar/StatusBar.tsx`, and `src/app/viewmodel/Common/status-bar/use-status-bar-viewmodel.ts`.
- [X] T019 [US1] Classify catalog component inventory for `src/app/components/Catalog/bulk-add-dialog/BulkAddDialog.tsx`, `src/app/components/Catalog/catalog-details-card/CatalogDetailsCard.tsx`, `src/app/components/Catalog/catalog-page/CatalogsPage.tsx`, `src/app/components/Catalog/catalogs-card/CatalogsCard.tsx`, `src/app/components/Catalog/create-dialog/CreateCatalogDialog.tsx`, `src/app/components/Catalog/tokens-card/TokensCard.tsx`, and their matching `use-*-viewmodel.ts` and `actions/*-action-type.ts` files.
- [X] T020 [US1] Classify template component inventory for `src/app/components/Template/create-template-dialog/CreateTemplateDialog.tsx`, `src/app/components/Template/groups-card/GroupsCard.tsx`, `src/app/components/Template/mappings-card/MappingsCard.tsx`, `src/app/components/Template/template-catalogs-card/TemplateCatalogsCard.tsx`, `src/app/components/Template/template-details-card/TemplateDetailsCard.tsx`, `src/app/components/Template/template-page/TemplatesPage.tsx`, `src/app/components/Template/templates-card/TemplatesCard.tsx`, and their matching `use-*-viewmodel.ts` and `actions/*-action-type.ts` files.
- [X] T021 [US1] Classify theme component inventory for `src/app/components/Theme/create-theme-dialog/CreateThemeDialog.tsx`, `src/app/components/Theme/editor-previews-card/EditorPreviewsCard.tsx`, `src/app/components/Theme/theme-details-card/ThemeDetailsCard.tsx`, `src/app/components/Theme/theme-page/ThemesPage.tsx`, `src/app/components/Theme/theme-palette-card/ThemePaletteCard.tsx`, `src/app/components/Theme/theme-variables-card/ThemeVariablesCard.tsx`, `src/app/components/Theme/themes-card/ThemesCard.tsx`, and their matching `use-*-viewmodel.ts` and `actions/*-action-type.ts` files.
...
- [X] T032 [P] [US2] Remediate common action contracts, handlers, viewmodels, components, and controllers in `src/app/actions/Common/eyedropper-overlay/eyedropper-overlay-action-type.ts`, `src/app/actions/Common/eyedropper-overlay/eyedropper-overlay-handler.ts`, `src/app/viewmodel/Common/eyedropper-overlay/use-eyedropper-overlay-viewmodel.ts`, `src/app/components/Common/eyedropper-overlay/EyedropperOverlay.tsx`, `src/app/actions/Common/styled-tooltip/styled-tooltip-action-type.ts`, `src/app/actions/Common/styled-tooltip/styled-tooltip-handler.ts`, `src/app/viewmodel/Common/styled-tooltip/use-styled-tooltip-viewmodel.ts`, and `src/app/components/Common/styled-tooltip/StyledTooltip.tsx`.
- [X] T033 [P] [US2] Remediate app shell action contracts, handlers, viewmodels, components, and controllers in `src/app/actions/Common/app-shell/app-shell-action-type.ts`, `src/app/actions/Common/app-shell/app-shell-handler.ts`, `src/app/viewmodel/Common/app-shell/use-app-shell-viewmodel.ts`, `src/app/components/Common/app-shell/AppShell.tsx`, `src/app/actions/Common/menu-bar/app-menu-action-type.ts`, `src/app/actions/Common/menu-bar/app-menu-handler.ts`, `src/app/viewmodel/Common/menu-bar/use-menubar-viewmodel.ts`, `src/app/components/Common/menu-bar/MenuBar.tsx`, `src/app/actions/Common/ribbon/app-ribbon-action-type.ts`, `src/app/actions/Common/ribbon/app-ribbon-handler.ts`, `src/app/viewmodel/Common/ribbon/use-ribbon-viewmodel.ts`, `src/app/components/Common/ribbon/Ribbon.tsx`, `src/app/viewmodel/Common/status-bar/use-status-bar-viewmodel.ts`, and `src/app/components/Common/status-bar/StatusBar.tsx`.
- [X] T034 [P] [US2] Remediate catalog action contracts, handlers, viewmodels, components, and controllers in `src/app/actions/Catalog/catalog-action-type.ts`, `src/app/actions/Catalog/catalog-handler.ts`, `src/app/catalog/bulk-add-dialog/`, `src/app/catalog/catalog-details-card/`, `src/app/catalog/catalog-page/`, `src/app/catalog/catalogs-card/`, `src/app/catalog/create-dialog/`, and `src/app/catalog/tokens-card/`.
- [X] T035 [P] [US2] Remediate template action contracts, handlers, viewmodels, components, and controllers in `src/app/actions/Template/template-action-type.ts`, `src/app/actions/Template/template-handler.ts`, `src/app/template/create-template-dialog/`, `src/app/template/groups-card/`, `src/app/template/mappings-card/`, `src/app/template/template-catalogs-card/`, `src/app/template/template-details-card/`, `src/app/template/template-page/`, `src/app/template/templates-card/`, and `src/app/template/variables-card/`.
- [X] T036 [P] [US2] Remediate theme action contracts, handlers, viewmodels, components, and controllers in `src/app/actions/Theme/theme-action-type.ts`, `src/app/actions/Theme/theme-handler.ts`, `src/app/theme/create-theme-dialog/`, `src/app/theme/editor-previews-card/`, `src/app/theme/theme-details-card/`, `src/app/theme/theme-page/`, `src/app/theme/theme-palette-card/`, `src/app/theme/theme-variables-card/`, and `src/app/theme/themes-card/`.
